...
class ESPnetEnhASRModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #logging.info(f"mask_pre['spk1'] requires_grad is {mask_pre['spk1'].requires_grad}")
        ...
        #logging.info(f"predicted_wav required_grad is {predicted_wav.requires_grad}") 
        ...
        loss_asr = (1 - self.enh_weight) * loss_asr
        loss_enh = self.enh_weight * loss_enh

        loss_asr, loss_enh, stats, weight = force_gatherable((loss_asr, loss_enh, stats, batch_size), loss.device)

        return (loss_asr, loss_enh), stats, weight
